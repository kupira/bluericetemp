...
public:
   ...
   * Glib::Variant, but <tt>nullptr</tt> instead.
   * 
   * @newin{2,28}
   * 
   ...
   * given as the state. All calls to Gio::Action::change_state() must give a
   ...
   * then this function will return <tt>nullptr</tt>. In that case, Gio::Action::get_state()
   * will return <tt>nullptr</tt> and you must not call Gio::Action::change_state().
   * 
   * @newin{2,28}
   * 
   ...
   * 
   * If the @a value Glib::Variant is floating, it is consumed.
   * 
   * @newin{2,30}
   * 
   * @param value The new state.
   ...
   * 
   * If the @a parameter Glib::Variant is floating, it is consumed.
   * 
   * @newin{2,28}
   * 
   * @param parameter The parameter to the activation.
   ...
   * 
   * It is an error to call this function with a non-UTF-8 @a action_name.
   ...
   * target value is parsed using glib_variant_parse().  If a tuple-typed
   ...
   * 
   * If this function returns <tt>true</tt>, a non-<tt>nullptr</tt> value is guaranteed to be returned
   * in @a action_name (if a pointer is passed in). A <tt>nullptr</tt> value may still be
   * returned in @a target_value, as the @a detailed_name may not contain a target.
   * 
   * If returned, the Glib::Variant in @a target_value is guaranteed to not be floating.
   * 
   * @newin{2,38}
   * 
   * @param detailed_name A detailed action name.
   ...
   * or <tt>nullptr</tt> for no target.
   * 
   ...
   * 
   * This function is the opposite of gio_action_parse_detailed_name().
   * It will produce a string that can be parsed back to the @a action_name
   * and @a target_value by that function.
   * 
   * See that function for the types of strings that will be printed by
   ...
   * @param target_value A Glib::Variant target value, or <tt>nullptr</tt>.
   ...
   * Gio::Action::change_state() have no effect.
   * 
   * @newin{2,28}
   *
  ...
  /** The Glib::VariantType of the state that the action has, or <tt>nullptr</tt> if the
