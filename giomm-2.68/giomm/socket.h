...
public:
  ...
  /** Receives data (up to @a size bytes) from a socket.
   * 
   * This function is a variant of Gio::Socket::receive() which returns a
   * Glib::Bytes rather than a plain buffer.
   * 
   * Pass `-1` to @a timeout_us to block indefinitely until data is received (or
   * the connection is closed, or there is an error). Pass `0` to use the default
   * timeout from Gio::Socket::property_timeout(), or pass a positive number to wait
   * for that many microseconds for data before returning `Gio::Error::TIMED_OUT`.
   * 
   * @newin{2,80}
   * 
   * @param size The number of bytes you want to read from the socket.
   * @param timeout_us The timeout to wait for, in microseconds, or `-1` to block
   * indefinitely.
   * @param cancellable A Cancellable, or <tt>nullptr</tt>.
   * @return A bytes buffer containing the
   * received bytes, or <tt>nullptr</tt> on error.
   * 
   * @throws Glib::Error
   */
  Glib::RefPtr<Glib::Bytes> receive_bytes(gsize size, gint64 timeout_us, const Glib::RefPtr<Cancellable>& cancellable =  {});
  ...
  /** Receive data (up to @a size bytes) from a socket.
   * 
   * This function is a variant of Gio::Socket::receive_from() which returns
   * a Glib::Bytes rather than a plain buffer.
   * 
   * If @a address is non-<tt>nullptr</tt> then @a address will be set equal to the
   * source address of the received packet.
   * 
   * The @a address is owned by the caller.
   * 
   * Pass `-1` to @a timeout_us to block indefinitely until data is received (or
   * the connection is closed, or there is an error). Pass `0` to use the default
   * timeout from Gio::Socket::property_timeout(), or pass a positive number to wait
   ...
   * @newin{2,80}
   * 
   * @param address Return location for a SocketAddress.
   * @param size The number of bytes you want to read from the socket.
   * @param timeout_us The timeout to wait for, in microseconds, or `-1` to block
   * indefinitely.
   * @param cancellable A Cancellable, or <tt>nullptr</tt>.
   ...
   * @throws Glib::Error
   */
  Glib::RefPtr<Glib::Bytes> receive_bytes_from(Glib::RefPtr<SocketAddress>& address, gsize size, gint64 timeout_us, const Glib::RefPtr<Cancellable>& cancellable =  {});
