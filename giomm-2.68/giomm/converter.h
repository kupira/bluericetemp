...
public:
  ...
  /** Applies @a converter to the data in @a bytes.
   * 
   * @newin{2,82}
   * 
   * @param bytes The data to convert.
   * @return A newly-allocated
   * `Bytes` with the converted data, or <tt>nullptr</tt> if an error
   * occurred.
   * 
   * @throws Glib::Error
   */
  Glib::RefPtr<Glib::Bytes> convert(const Glib::RefPtr<const Glib::Bytes>& bytes);
