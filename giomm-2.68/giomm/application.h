...
public:
  ...
  /** Gets the version of @a application.
   * 
   * @newin{2,80}
   * 
   * @return The version of @a application.
   */
  Glib::ustring get_version() const;
  
  /** Sets the version number of @a application. This will be used to implement
   * a `--version` command line argument
   * 
   * The application version can only be modified if @a application has not yet
   * been registered.
   * 
   * @newin{2,80}
   * 
   * @param version The version of @a application.
   */
   ...
   * 
   * It is an error to call this function if @a application has no
   * application ID.
   * 
   * @newin{2,40}
   * 
