...
public:
   ...
   * 
   * The caller is responsible for freeing the list with glib_strfreev() when
   ...
   * Gio::ActionGroup::has_action(), Gio::ActionGroup::get_action_enabled(),
   * Gio::ActionGroup::get_action_parameter_type(),
   * Gio::ActionGroup::get_action_state_type(),
   * Gio::ActionGroup::get_action_state_hint() and
   * Gio::ActionGroup::get_action_state() with a single function call.
   * 
   ...
   * 
   * When activating the action using Gio::ActionGroup::activate_action(),
   ...
   * Gio::ActionGroup::change_action_state() must give a Glib::Variant of this
   * type and Gio::ActionGroup::get_action_state() will return a Glib::Variant
   * of the same type.
   * 
   * If the action is not stateful then this function will return <tt>nullptr</tt>.
   * In that case, Gio::ActionGroup::get_action_state() will return <tt>nullptr</tt>
  ...
  /** Emits the Gio::ActionGroup::signal_action_added() signal on @a action_group.
   * 
  ...
  /** Emits the Gio::ActionGroup::signal_action_removed() signal on @a action_group.
   * 
   * This function should only be called by Gio::ActionGroup implementations.
   * 
   * @newin{2,28}
  ...
  /** Emits the Gio::ActionGroup::signal_action_enabled_changed() signal on @a action_group.
   * 
   * This function should only be called by Gio::ActionGroup implementations.
   * 
   * @newin{2,28}
  ...
  /** Emits the Gio::ActionGroup::signal_action_state_changed() signal on @a action_group.
   * 
   * This function should only be called by Gio::ActionGroup implementations.
   * 
   * @newin{2,28}
