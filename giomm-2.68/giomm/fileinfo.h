...
public:
   ...
   *  @a dest_info, and then copies all of the file attributes from @a src_info to @a dest_info.
   * 
   ...
   * provided, the resulting DateTime will additionally have microsecond
   * precision.
   * 
