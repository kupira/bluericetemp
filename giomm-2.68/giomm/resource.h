...
public:
   ...
   * to register it with gio_resources_register().
   * 
   ...
   * @return A new Gio::Resource, or <tt>nullptr</tt> on error.
   * 
   ...
   * 
   * The only error this can return is Gio::ResourceError::NOT_FOUND, if @a path was
   * not found in @a resource.
   * 
   * @newin{2,44}
   * 
   * @param path A path name inside the resource.
   * @param lookup_flags A Gio::ResourceLookupFlags.
   * @return Gio::InputStream or <tt>nullptr</tt> on error.
   * 
   ...
   *  @a lookup_flags controls the behaviour of the lookup.
   * 
   * This can return error Gio::ResourceError::NOT_FOUND if @a path was not found in
   *  @a resource, or Gio::ResourceError::INTERNAL if decompression of a compressed
   * resource failed.
   * 
   * @newin{2,44}
   * 
   * @param path A path name inside the resource.
   * @param lookup_flags A Gio::ResourceLookupFlags.
   * @return Glib::Bytes or <tt>nullptr</tt> on error.
   * 
   * @throws Gio::ResourceError
   */
   ...
   * 
   * The return result is a <tt>nullptr</tt> terminated list of strings which should
   * be released with glib_strfreev().
   * 
   * If @a path is invalid or does not exist in the Gio::Resource,
  ...
  /** Returns whether the specified @a path in the resource
   * has children.
   * 
   * @newin{2,84}
   * 
   * @param path A pathname inside the resource.
   * @return <tt>true</tt> if @a path has children.
   */
  bool has_children(const std::string& path) const;
  ...
  /** Returns whether the specified @a path in the set of
   * globally registered resources has children.
   * 
   * @newin{2,84}
   * 
   * @param path A pathname.
   * @return <tt>true</tt> if @a patch has children.
   */
  static bool has_children_global(const std::string& path);
