...
public:
   ...
   * 
   *  @var CopyFlags::TARGET_DEFAULT_MODIFIED_TIME
   * Use default modification
   * timestamps instead of copying them from the source file. @newin{2,80}
   */
  ...
  enum class CopyFlags
  {
    ...
    TARGET_DEFAULT_MODIFIED_TIME = (1 << 6)
  };
   ...
   * is too long a Gio::Error with FILENAME_TOO_LONG will be thrown.
   ...
   * overwriting it. If this fails a Gio::Error with CANT_CREATE_BACKUP will be thrown. If you want to replace
   ...
   * other form of non-regular file then a Gio::Error with NOT_REGULAR_FILE will be thrown. Some file
   * systems don't allow all file names, and may throw a Gio::Error with INVALID_FILENAME, and if the
   * name is too long a Gio::Error with FILENAME_TOO_LONG will be thrown. Other errors are possible too, and
  ...
  */
   ...
   */
  void query_default_handler_async(const SlotAsyncReady& slot, const Glib::RefPtr<Cancellable>& cancellable =  {}, int io_priority =  Glib::PRIORITY_DEFAULT);
   ...
   * @throws Glib::Error
   */
  Glib::RefPtr<AppInfo> query_default_handler_finish(const Glib::RefPtr<AsyncResult>& result);
  ...
  */
  ...
  /** Checks if @a file supports thread-default main contexts
