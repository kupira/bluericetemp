...
public:
   ...
   * @return A new Gio::DesktopAppInfo, or <tt>nullptr</tt> if no
   ...
   * @newin{2,18}
   * 
   * @param key_file An opened Glib::KeyFile.
   * @return A new Gio::DesktopAppInfo or <tt>nullptr</tt> on error.
   */
   ...
   * Gio::DesktopAppInfo::new_from_keyfile(), this function will return <tt>nullptr</tt>.
   * 
   * @newin{2,24}
   * 
   ...
   * @newin{2,34}
   * 
   * @return The startup WM class, or <tt>nullptr</tt> if none
   * is set in the desktop file.
   */
  std::string get_startup_wm_class() const;
  
  /** Gets the value of the
   * [`No::Display` key](https://specifications.freedesktop.org/desktop-entry-spec/latest/ar01s06.html#key-nodisplay)
   * which helps determine if the application info should be shown in menus. See
   * `G_KEY_FILE_DESKTOP_KEY_NO_DISPLAY` and Gio::AppInfo::should_show().
   * 
   * @newin{2,30}
   * 
   * @return The value of the `No::Display` key.
   */
   ...
   * 
   * Note that Gio::AppInfo::should_show() for @a info will include this check
   * (with <tt>nullptr</tt> for @a desktop_env) as well as additional checks.
   * 
   * @newin{2,30}
   * 
   ...
   * `OnlyShowIn` and `NotShowIn` keys, <tt>false</tt> otherwise.
   */
   ...
   * 
   * @return The value of the
   * [`Generic::Name` key](https://specifications.freedesktop.org/desktop-entry-spec/latest/ar01s06.html#key-genericname).
   */
   ...
   * 
   * @param key The key to look up.
   * @return A newly allocated string, or <tt>nullptr</tt> if the key is not
   * found.
   */
   ...
   * 
   * @param key The key to look up.
   * @return The boolean value, or <tt>false</tt> if the key is not found.
   */
   ...
   * 
   * @return A
   * list of strings, always non-<tt>nullptr</tt>.
   */
   ...
   * @param launch_context A Gio::AppLaunchContext.
   */
