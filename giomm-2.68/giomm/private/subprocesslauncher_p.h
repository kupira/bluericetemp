...
#ifndef _GIOMM_SUBPROCESSLAUNCHER_P_H
#define _GIOMM_SUBPROCESSLAUNCHER_P_H
...
class GIOMM_API SubprocessLauncher_Class : public Glib::Class
{
public:
...
#endif /* _GIOMM_SUBPROCESSLAUNCHER_P_H */
