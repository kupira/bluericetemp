...
public:
  ...
  /** Get the timeout applied to all resolver lookups. See Resolver::property_timeout().
   * 
   * @newin{2,78}
   * 
  ...
  /** Set the timeout applied to all resolver lookups. See Resolver::property_timeout().
   * 
   * @newin{2,78}
   * 
   ...
   * 
   * This may be changed through the lifetime of the Resolver. The new value
