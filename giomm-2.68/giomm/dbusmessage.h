...
public:
   ...
   * @return A string that should be freed with glib_free().
   */
   ...
   * does not allow the @a serial to be zero.
   * 
   * @newin{2,26}
   * 
   ...
   * 
   * See Gio::DBusMessage::get_arg0_path() for returning object-path-typed
   * arg0 values.
   * 
   * @newin{2,26}
   * 
   ...
   * @newin{2,80}
   * 
   * @return The object path item or <tt>nullptr</tt> if the first item in the
   * body of @a message is not an object path.
   */
