...
public:
   ...
   * No flags.
   * 
   *  @var CreateFlags::NEEDS_TERMINAL
   * Application opens in a terminal window.
   * 
   *  @var CreateFlags::SUPPORTS_URIS
   * Application supports URI arguments.
   * 
   *  @var CreateFlags::SUPPORTS_STARTUP_NOTIFICATION
   ...
   * <tt>AppInfo::CreateFlags operator|(AppInfo::CreateFlags, AppInfo::CreateFlags)</tt><br>
   * <tt>AppInfo::CreateFlags operator&(AppInfo::CreateFlags, AppInfo::CreateFlags)</tt><br>
   * <tt>AppInfo::CreateFlags operator^(AppInfo::CreateFlags, AppInfo::CreateFlags)</tt><br>
   * <tt>AppInfo::CreateFlags operator~(AppInfo::CreateFlags)</tt><br>
   * <tt>AppInfo::CreateFlags& operator|=(AppInfo::CreateFlags&, AppInfo::CreateFlags)</tt><br>
   * <tt>AppInfo::CreateFlags& operator&=(AppInfo::CreateFlags&, AppInfo::CreateFlags)</tt><br>
   * <tt>AppInfo::CreateFlags& operator^=(AppInfo::CreateFlags&, AppInfo::CreateFlags)</tt><br>
   */
   ...
   * 
   * Note that the returned ID may be <tt>nullptr</tt>, depending on how the @a appinfo has
   * been constructed.
   * 
   ...
   * @newin{2,20}
   * 
   * @return A string containing the @a appinfo’s
   * commandline, or <tt>nullptr</tt> if this information is not available.
   */
   ...
   * 
   * @return The default Gio::Icon for
   *  @a appinfo or <tt>nullptr</tt> if there is no default icon.
   */
   ...
   * variables are also set, based on information provided in @a context.
   * 
   ...
   * as arguments, using the optional @a context to get information
   * about the details of the launcher (like what screen it is on).
   * On error, @a error will be set accordingly. If the application only supports
   ...
   * gio_app_info_launch_default_for_uri_async().
   * 
   * @newin{2,60}
   * 
   * @param uris A list of URIs to launch.
   ...
   * @param slot A Gio::SlotAsyncReady to call
   ...
   * 
   * @return <tt>true</tt> if it is possible to remove supported content types from a
   * given @a appinfo, <tt>false</tt> if not.
   */
   ...
   * Gio::AppInfo::add_supports_type(), but only those exported directly by
   * the application.
   * 
   * @newin{2,34}
   * 
   ...
   * gio_app_info_get_recommended_for_type(), regardless of the default
   ...
   * list of references to Gio::AppInfos.
   */
  static std::vector<Glib::RefPtr<AppInfo>> get_all();

  
  /** Gets a list of all Gio::AppInfos for a given content type,
   * including the recommended and fallback Gio::AppInfos. See
   * gio_app_info_get_recommended_for_type() and
   * gio_app_info_get_fallback_for_type().
   * 
   * @param content_type The content type to find a Gio::AppInfo for.
   * @return List of
   * Gio::AppInfos for given @a content_type.
   */
   ...
   * the last one for which Gio::AppInfo::set_as_last_used_for_type() has
   * been called.
   * 
   * @newin{2,76}
   * 
   * @param content_type The content type to find a Gio::AppInfo for.
   * @return List of
   * Gio::AppInfos for given @a content_type or <tt>nullptr</tt> on error.
   */
  static std::vector<Glib::RefPtr<AppInfo>> get_recommended_for_type(const std::string& content_type);
  
  /** Gets a list of fallback Gio::AppInfos for a given content type, i.e.\ those applications which claim to support the given content type by MIME
   * type subclassing and not directly.
   * 
   * @newin{2,76}
   * 
   * @param content_type The content type to find a Gio::AppInfo for.
   * @return List of Gio::AppInfos
   ...
   * 
   * @param content_type The content type to find a Gio::AppInfo for.
   * @param must_support_uris If <tt>true</tt>, the Gio::AppInfo is expected to
   * support URIs.
   * @return Gio::AppInfo for given
   *  @a content_type or <tt>nullptr</tt> on error.
   */
   ...
   * gio_app_info_get_default_for_type_async().
   * 
   * If no #Gio::AppInfo is found, then @a error will be set to
   * [error@Gio.IOErrorEnum.NOT_FOUND].
   * 
   * @newin{2,74}
   * 
   * @param result The async result.
   * @return Gio::AppInfo for given @a content_type or
   ...
   * @return Gio::AppInfo for given
   *  @a uri_scheme or <tt>nullptr</tt> on error.
   */
   ...
   * @newin{2,74}
   * 
   * @param content_type A string containing a URI scheme.
   * @param cancellable A Gio::Cancellable.
   * @param slot A Gio::SlotAsyncReady to call
   * when the request is done.
   */
  ...
  /** Finishes a default Gio::AppInfo lookup started by
   * gio_app_info_get_default_for_uri_scheme_async().
   * 
   * If no Gio::AppInfo is found, then @a error will be set to
   * [error@Gio.IOErrorEnum.NOT_FOUND].
   * 
   ...
   * 
   * @param result The async result.
   * @return Gio::AppInfo for given @a uri_scheme or
   * <tt>nullptr</tt> on error.
   * 
   * @throws Glib::Error
   */
   ...
   * Gio::AppInfo::add_supports_type() or
   ...
   * gio_app_info_launch_default_for_uri_async() instead.
   * 
